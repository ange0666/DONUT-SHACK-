        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img src = "images/img/LOGO1.png" width = 250 height = 60 hspace = 25 align = left border = "1"> </a>
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="donutmenu.php?res_id=<?php echo $_GET['res_id']; ?>">Pick your favourite Food</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="checkout.php">Get delivered & Pay</a></li>
                    </ul>
                </div>
            </div>
            <!-- end:Top links -->
            ...
            <?php $ress= mysqli_query($db,"select * from shop where rs_id='$_GET[res_id]'");
                                         $rows=mysqli_fetch_array($ress);
                                          ...
                                          ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/BGG3.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
...
?>                                  
                                        ...
                                        <div class="title-row">
                                        <?php echo $item["title"]; ?><a href="donutmenu.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>" >
...
?>                                
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        <p>Total Amount</p>
                                        <h3 class="value"><strong>P<?php echo $item_total; ?></strong></h3>
                                        <p>Free Shipping</p>
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <?php  // display values and item of food/food
                                    $stmt = $db->prepare("select * from food where rs_id='$_GET[res_id]'");
                                    $stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
                                        ...
                                        <form method="post" action='donutmenu.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="shop-logo pull-left" href="#"><?php echo '<img src="admin/Shop_img/foods/'.$product['img'].'" alt="Food logo">'; ?></a>
                                            </div>
                                            <!-- end:Logo -->
                                        ...
                                        <span class="price pull-left" >P<?php echo $product['price']; ?></span>
