...
<head>
    ...
    <link href="css/akingstyle.css" rel="stylesheet">
...
<body>
     <style>
        ...
        <div class="page-wrapper">
            ...
            <div class="inner-page-hero bg-image" data-image-src="images/img/BG33.jpg">
              ...
              ?>
                        <tr>  
                             <td data-column="Item"> <?php echo $row['title']; ?></td>
                              ...
                              <td data-column="Price">P<?php echo $row['price']; ?></td>
                               ...
                               <?php 
                                      ...
                                      {
                                      ?>
                                      <button type="button" class="takeact" style="font-weight:bold;">Dispatch</button>
                                       <?php 
                                        }
                                         if($status=="in process")
                                       { ?>
                                        <button type="button" class="takeact"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span>Processing</button>
                                      <?php
                                        }
                                      if($status=="closed")
                                        {
                                      ?>
                                       <button type="button" class="takeact" ><span  class="fa fa-check-circle" aria-hidden="true">Delivered</button> 
                                      <?php 
                                      } 
                                      ?>
                                      <?php
                                      if($status=="rejected")
                                        {
                                      ?>
                                       <button type="button" class="takeact"> <i class="fa fa-close"></i>Cancelled</button>
                                      <?php 
                                      } 
                                      ?>
