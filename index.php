...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/BG.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <br>
                    <h1>WELCOME TO DONUT SHACK</h1>
                    <h5 class="font-white space-xs">Oh Dough! Donuts!</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">Shop....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder=""> </div>
                            </div>
                            <button onclick="location.href='shop.php'" type="button" class="btn theme-btn btn-lg">Search Shop</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Shops</h4> </div>
                        <!-- end:Step -->
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <p class="lead">WE’VE GOT SOMETHING FOR YOU</p>
                </div>
                <div class="row">
                        ...
                        <?php 
                        // fetch records from database to display popular first 3 foods from table
                        $query_res= mysqli_query($db,"select * from food LIMIT 3"); 
                                          while($r=mysqli_fetch_array($query_res))
                                          {
                                                    
                                               echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                                        <div class="food-item-wrap">
                                                            <div class="figure-wrap bg-image" data-image-src="admin/Shop_img/foods/'.$r['img'].'">
                                                                <div class="distance"><i class="fa fa-pin"></i>5 km</div>
                                                                <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                                                                <div class="review pull-right"><a href="#">198 reviews</a> </div>
                                                            </div>
                                                            <div class="content">
                                                                <h5><a href="donutmenu.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5>
                                                                <div class="product-name">'.$r['slogan'].'</div>
                                                                <div class="price-btn-block"> <span class="price">P'.$r['price'].'</span> <a href="donutmenu.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                            </div>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose some Shop</h3>
                                    <p>We got you covered with 5+ city to delivered offer to you.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>We are serving you more than 30+ popular Donuts varieties.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your food delivered within 15/30 mins and enjoy your food!</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="featured-shop">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <!-- shop filter nav starts -->
                        <div class="shop-filter pull-right">
                            <nav class="primary pull-left">
                                <ul>
                                    <li><a href="#" class="selected" data-filter="*">Donut Shop(Caloocan City)</a> </li>
                                    <?php 
                                                        ...
                                                        <div class="shop-wrap">
                                                            <div class="row">
                                                                <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                                                    <a class="shop-logo" href="donutmenu.php?res_id='.$rows['rs_id'].'" > <img src="admin/Shop_img/'.$rows['image'].'" alt="Shop logo"> </a>
                                                                </div>
                                                                <!--end:col -->
                                                                <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                                                    <h5><a href="donutmenu.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
        ...
        <footer class="footer">
          ...
          class="logo"> </a> <span>Choose it &amp; Enjoy your meals! </span> </a></div>
                    ...
                    <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Enjoy your foods :)</a></li>
                        </ul>
                    </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            ...
                            <p>Hermosa St. Tondo Manila City</p>
