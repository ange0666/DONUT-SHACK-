...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                ...
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>2</span><a>Pick your favourite Food</a></li>
            ...
            <div class="inner-page-hero bg-image" data-image-src="images/img/BG2.jpg">
                                          ...
                                          while($rows=mysqli_fetch_array($ress))
                                          {
                                                     ...
                                                     echo' <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
                                                            <div class="entry-logo">
                                                                <a class="img-fluid" href="donutmenu.php?res_id='.$rows['rs_id'].'" > <img src="admin/Shop_img/'.$rows['image'].'" alt="Food logo"></a>
                                                            </div>
                                                            <!-- end:Logo -->
                                                            <div class="entry-dscr">
                                                                <h5><a href="donutmenu.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].' <a href="#">...</a></span>
                                                         ...
                                                         <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
                                                                <div class="right-content bg-white">
                                                                    <div class="right-review">
                                                                        ...
                                                                        <p> 100 Reviews</p> <a href="donutmenu.php?res_id='.$rows['rs_id'].'" class="btn theme-btn-dash">View Menu</a> </div>
                                                                </div>
                                                                <!-- end:right info -->
                                                            </div>';
                                          }
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <a href="#"> <img src = "images/img/LOGO.png" width = 130
